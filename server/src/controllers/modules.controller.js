...
exports.create = async (req, res) => {
  return created(res, { message: 'modules created (implement me)' });
};

exports.update = async (req, res) => {
  return ok(res, { message: 'modules updated (implement me)' });
};

exports.remove = async (req, res) => {
  return ok(res, { message: 'modules deleted (implement me)' });
};
